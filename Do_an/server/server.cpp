ï»¿// 123.cpp : Defines the entry point for the console application.
//
...
town Town[7] = {
					...
					{"Ca Mau", {{"10000", "Giai Nhat", "943168"}, {"8000", "Giai Nhi", "761540"}, {"5000", "Giai Ba", "123789"}}},
					{"Kien Giang", {{"10000", "Giai Nhat", "264589"}, {"8000", "Giai Nhi", "164059"}, {"5000", "Giai Ba", "123789"}}},
					{"Binh THuan", {{"10000", "Giai Nhat", "164235"}, {"8000", "Giai Nhi", "103987"}, {"5000", "Giai Ba", "123789"}}},
					{"Tien GIang", {{"10000", "Giai Nhat", "247590"}, {"8000", "Giai Nhi", "204796"}, {"5000", "Giai Ba", "123789"}}},
		...
		else
		{
			...
			for(int i = 0; i < numClient; i++){
				...
				do{
					...
					// xá»­ lÃ½ cÃ¢u truy váº¥n.
       				char *st = new char[50];
					strcpy(st, command);
       				int index = search(st);

					// gá»Ÿi káº¿t quáº£ Ä‘áº¿n client.
					int twn = -1;
					...
					case 1:
						...
						// gá»Ÿi hÆ°á»›ng dáº«n cÃ¢u truy váº¥n.
						...
						// gá»Ÿi thÃ´ng tin cÃ¡c tá»‰nh má»Ÿ thÆ°á»Ÿng.
						for(int j = 0; j < 7; j++){
